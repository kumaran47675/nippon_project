...
const MainPage = ({ requestId,setRequestId,userId, userName,depot}) => {
        ...
        <Layout>
          ...
          >
            <Routes>
              ...
              <Route path="/observationform" element={<Observation userId={userId} depot={depot}/>} />
              <Route path="/observationtable" element={<ObservationTable userId={userId}/>} />
              <Route path="/tinting" element={<FillPage userId={userId} setRequestId={setRequestId}  requestId={requestId} depot={depot} />} />
              {/* <Route path="/colourant" element={<ColourantBanco />} /> */}
              <Route path="/tintingtable" element={<TintingTable  />} />
              <Route path="/assets" element={<UploadFileComponent/>} />
            </Routes>
          </Content>
        </Layout>
      </Layout>
